        ...
        if (timer == null) {
            ...
            TimerTask task = new TimerTask() {
                ...
                public void run() {
                    ...
                    Message msg = MusicActivity.handler.obtainMessage();//仓创建消息对象
        ...
        public void play() {
            ...
            switch (selectedMusic){
                case ("青花瓷"):
                    ...
                    break;
                case ("江南"):
                    mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.jiangnan);
                    break;
                case ("泡沫"):
                    mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.pamo);
                    break;
            }
            mediaPlayer.start();
            addTimer();
